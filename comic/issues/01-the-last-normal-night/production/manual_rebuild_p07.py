...
# Crop away the candidate's production labels and noncanonical narration while retaining its canonical speech balloons.
a=fit(src,(p1[2]-p1[0],p1[3]-p1[1]),(100,150,1040,500),(.52,.52)); p.paste(a,p1[:2]); border(d,p1)
a=fit(src,(p2[2]-p2[0],p2[3]-p2[1]),(220,510,900,760),(.53,.52)); p.paste(a,p2[:2]); border(d,p2)
a=fit(src,(p3[2]-p3[0],p3[3]-p3[1]),(0,905,1040,1172),(.48,.52)); p.paste(a,p3[:2]); border(d,p3)
a=fit(src,(p4[2]-p4[0],p4[3]-p4[1]),(240,1180,850,1390),(.55,.52)); p.paste(a,p4[:2]); border(d,p4)
