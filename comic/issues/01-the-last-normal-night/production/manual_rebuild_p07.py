...
# Approved candidate art, cropped to remove all production labels and both noncanonical narration boxes.
...
a=fit(src,(p4[2]-p4[0],p4[3]-p4[1]),(280,1210,830,1415),(.52,.52)); p.paste(a,p4[:2]); border(d,p4)
